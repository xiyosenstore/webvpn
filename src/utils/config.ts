export const MAIN_DOMAINS = [
  "redirect-1.benxx.workers.dev", "api24-normal.tiktokv.com.redirect.benxx.workers.dev",  "ava.game.naver.com.redirect.benxx.workers.dev"
];
...
export const CONFIG = {
  proxyListUrl: "https://raw.githubusercontent.com/zerokit-769/testt/refs/heads/main/ProxyList%20(1).txt",
  apiCheckUrl: "https://proxyip-check.bexcodex.xyz/",
  pathTemplate: "/{ip}-{port}",
  webName: "Benx-project"
};
