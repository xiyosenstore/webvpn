export const MAIN_DOMAINS = [
  "webvpn.benx.workers.dev", "ava.game.naver.com.webvpn.benx.workers.dev", "api24-normal.tiktokv.com.webvpn.benx.workers.dev"
];
...
export const CONFIG = {
  proxyListUrl: "https://raw.githubusercontent.com/xiyosenstore/ProxyList/main/rawProxyList.txt",
